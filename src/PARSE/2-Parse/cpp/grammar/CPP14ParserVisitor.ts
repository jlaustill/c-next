...
import { NewExpression_Context } from "./CPP14Parser";
import { NewPlacementContext } from "./CPP14Parser";
import { NewTypeIdContext } from "./CPP14Parser";
import { NewDeclarator_Context } from "./CPP14Parser";
import { NoPointerNewDeclaratorContext } from "./CPP14Parser";
import { NewInitializer_Context } from "./CPP14Parser";
...
import { EmptyDeclaration_Context } from "./CPP14Parser";
 ...
 */
export class CPP14ParserVisitor<
  Result,
> extends AbstractParseTreeVisitor<Result> {
   ...
   * @return the visitor result
   */
  visitPointerMemberExpression?: (
    ctx: PointerMemberExpressionContext,
  ) => Result;
  /**
   ...
   * @return the visitor result
   */
  visitTrailingTypeSpecifierSeq?: (
    ctx: TrailingTypeSpecifierSeqContext,
  ) => Result;
  /**
   ...
   * @return the visitor result
   */
  visitSimpleTypeLengthModifier?: (
    ctx: SimpleTypeLengthModifierContext,
  ) => Result;
  /**
   ...
   * @return the visitor result
   */
  visitSimpleTypeSignednessModifier?: (
    ctx: SimpleTypeSignednessModifierContext,
  ) => Result;
  /**
  ...
  visitElaboratedTypeSpecifier?: (
    ctx: ElaboratedTypeSpecifierContext,
  ) => Result;
  /**
  ...
  visitNamespaceAliasDefinition?: (
    ctx: NamespaceAliasDefinitionContext,
  ) => Result;
  /**
   ...
   * @return the visitor result
   */
  visitQualifiednamespacespecifier?: (
    ctx: QualifiednamespacespecifierContext,
  ) => Result;
  /**
  ...
  visitAttributeArgumentClause?: (
    ctx: AttributeArgumentClauseContext,
  ) => Result;
  /**
   ...
   * @return the visitor result
   */
  visitPointerAbstractDeclarator?: (
    ctx: PointerAbstractDeclaratorContext,
  ) => Result;
  /**
   ...
   * @return the visitor result
   */
  visitNoPointerAbstractDeclarator?: (
    ctx: NoPointerAbstractDeclaratorContext,
  ) => Result;
  /**
   ...
   * @return the visitor result
   */
  visitNoPointerAbstractPackDeclarator?: (
    ctx: NoPointerAbstractPackDeclaratorContext,
  ) => Result;
  /**
  ...
  visitParameterDeclarationClause?: (
    ctx: ParameterDeclarationClauseContext,
  ) => Result;
  /**
  ...
  visitParameterDeclarationList?: (
    ctx: ParameterDeclarationListContext,
  ) => Result;
  /**
   ...
   * @return the visitor result
   */
  visitBraceOrEqualInitializer?: (
    ctx: BraceOrEqualInitializerContext,
  ) => Result;
  /**
   ...
   * @return the visitor result
   */
  visitDynamicExceptionSpecification?: (
    ctx: DynamicExceptionSpecificationContext,
  ) => Result;
  /**
