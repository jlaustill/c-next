#ifndef U16_ARRAY_LENGTH_TEST_H
#define U16_ARRAY_LENGTH_TEST_H
...
/* External variables */
extern uint16_t globalArr[16];
extern uint16_t TestScope_publicArr[16];
