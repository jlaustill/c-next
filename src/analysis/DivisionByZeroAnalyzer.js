 ...
 */
class DivisionByZeroListener extends CNextListener_1.CNextListener {
  analyzer;
  // eslint-disable-next-line @typescript-eslint/lines-between-class-members
  constZeros;
  constructor(analyzer, constZeros) {
    super();
...
class DivisionByZeroAnalyzer {
  ...
  analyze(tree) {
    ...
    antlr4ng_1.ParseTreeWalker.DEFAULT.walk(collector, tree);
...
exports.DivisionByZeroAnalyzer = DivisionByZeroAnalyzer;
exports.default = DivisionByZeroAnalyzer;
