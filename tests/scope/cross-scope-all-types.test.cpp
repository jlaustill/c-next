...
int main(void) {
    ...
    if (Consumer__signedResult != -400) return 29U;
    Consumer__writeProviderU8(77U);
    uint8_t finalResult = Provider__getU8();
    if (finalResult != 77) return 30U;
    return 0U;
}
