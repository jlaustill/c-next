...
| file:line                                       | message                                                                                       | code      | position source                                                                                              | fixture                                                 |
| ----------------------------------------------- | --------------------------------------------------------------------------------------------- | --------- | ------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------- |
| `declarationGenerators/ScopeGenerator.ts:96`    | constructor argument must be const (C++)                                                      | NEW       | `varDecl.start` — line read at `:176`, inlined as prose                                                      | `constructor-syntax/error-non-const-arg`                |
