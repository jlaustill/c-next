...
int main(void) {
    ...
    uint8_t lowBits = static_cast<uint8_t>(((flags >> 0U) & ((1U << 3U) - 1)));
    uint8_t highBits = static_cast<uint8_t>(((flags >> 3U) & ((1U << 5U) - 1)));
    uint16_t lowWord = static_cast<uint16_t>(((registers >> 0U) & 0xFFFFU));
    ...
    uint8_t singleBit = static_cast<uint8_t>(((flags >> 0U) & ((1U << 1U) - 1)));
    uint8_t test = 0U;
    test = (test & ~(((1U << 2) - 1) << 0)) | ((3 & ((1U << 2) - 1)) << 0);
    test = (test & ~(((1U << 3) - 1) << 2)) | ((7 & ((1U << 3) - 1)) << 2);
    test = (test & ~(((1U << 3) - 1) << 5)) | ((6 & ((1U << 3) - 1)) << 5);
    uint8_t r1 = static_cast<uint8_t>(((test >> 0U) & ((1U << 2U) - 1)));
