#ifndef CNX_TESTS_ENUM_COMPREHENSIVE_ENUM_ALL_SCENARIOS_TEST_H
#define CNX_TESTS_ENUM_COMPREHENSIVE_ENUM_ALL_SCENARIOS_TEST_H
...
#endif /* CNX_TESTS_ENUM_COMPREHENSIVE_ENUM_ALL_SCENARIOS_TEST_H */
