...
int main(void) {
    ...
    bool maxBit = ((maxBitTest >> 31U) & 1);
    items[15].dword = 0xFFFFFFFFU;
    items[15].dword = (items[15].dword & ~(1U << 31)) | (0U << 31);
    bool complexMax = ((items[15U].dword >> 31U) & 1);
    items[0].byte = (items[0].byte & ~(1U << 0)) | (1U << 0);
    bool zeroIdx = ((items[0U].byte >> 0U) & 1);
    ...
    bool c0 = ((consecutive >> 0U) & 1);
    bool c1 = ((consecutive >> 1U) & 1);
    bool c2 = ((consecutive >> 2U) & 1);
    bool c3 = ((consecutive >> 3U) & 1);
    bool c4 = ((consecutive >> 4U) & 1);
    bool c5 = ((consecutive >> 5U) & 1);
    bool c6 = ((consecutive >> 6U) & 1);
    bool c7 = ((consecutive >> 7U) & 1);
}
