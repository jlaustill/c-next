#ifndef I16_ARRAY_LENGTH_TEST_H
#define I16_ARRAY_LENGTH_TEST_H
...
/* External variables */
extern int16_t globalArr[16];
extern int16_t TestScope_publicArr[16];
