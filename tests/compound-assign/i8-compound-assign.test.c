...
int main(void) {
    ...
    if (mod != -1) return 44U;
    int8_t andVal = 0x7F;
    andVal = (int8_t)(andVal & 0x0F);
    if (andVal != 0x0F) return 50U;
    andVal = -1;
    andVal = (int8_t)(andVal & 0x0F);
    if (andVal != 0x0F) return 51U;
    andVal = 0x55;
    andVal = (int8_t)(andVal & 0xAA);
    if (andVal != 0) return 52U;
    andVal = 0x7F;
    andVal = (int8_t)(andVal & 0x7F);
    if (andVal != 0x7F) return 53U;
    int8_t orVal = 0x0F;
    orVal = (int8_t)(orVal | 0x70);
    if (orVal != 0x7F) return 60U;
    orVal = 0x12;
    orVal = (int8_t)(orVal | 0x00);
    if (orVal != 0x12) return 61U;
    orVal = 0x55;
    orVal = (int8_t)(orVal | 0x2A);
    if (orVal != 0x7F) return 62U;
    int8_t xorVal = 0x55;
    xorVal = (int8_t)(xorVal ^ 0x55);
    if (xorVal != 0) return 70U;
    xorVal = 0x0F;
    xorVal = (int8_t)(xorVal ^ 0x70);
    if (xorVal != 0x7F) return 71U;
    xorVal = -1;
    xorVal = (int8_t)(xorVal ^ -1);
