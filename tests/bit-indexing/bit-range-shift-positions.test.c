...
int main(void) {
    ...
    value = 0;
    value = (value & ~(1 << 10)) | (1 << 10);
    if (value != 0x00000400) return 11;
    value = 0;
    value = (value & ~(1 << 11)) | (1 << 11);
    ...
    val64 = 0;
    val64 = (val64 & ~(1ULL << 48)) | ((uint64_t)1 << 48);
