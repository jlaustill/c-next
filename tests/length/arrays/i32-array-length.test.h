#ifndef I32_ARRAY_LENGTH_TEST_H
#define I32_ARRAY_LENGTH_TEST_H
...
/* External variables */
extern int32_t globalArr[16];
extern int32_t TestScope_publicArr[16];
