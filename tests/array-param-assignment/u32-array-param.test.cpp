...
#include "u32-array-param.test.hpp"
...
int main(void) {
    ...
    if (buffer[0U] != 100000) return 1U;
    writeU32(buffer, 3U, 999999U);
    if (buffer[3U] != 999999) return 2U;
    writeU32(buffer, 1U, 500000U);
    if (buffer[1U] != 500000) return 3U;
    uint32_t result = readU32(buffer, 0U);
    if (result != 100000) return 4U;
    result = readU32(buffer, 3U);
    if (result != 999999) return 5U;
    buffer[2] = 50U;
    incrementU32(buffer, 2U);
    if (buffer[2U] != 51) return 6U;
    incrementU32(buffer, 2U);
    incrementU32(buffer, 2U);
    if (buffer[2U] != 53) return 7U;
    uint32_t source[4] = {};
    uint32_t dest[4] = {};
    source[0] = 12345U;
    source[1] = 67890U;
    ...
    if (dest[0U] != 12345) return 8U;
    copyU32(source, dest, 1U);
    if (dest[1U] != 67890) return 9U;
    return 0U;
}
