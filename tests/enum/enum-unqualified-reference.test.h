#ifndef CNX_TESTS_ENUM_ENUM_UNQUALIFIED_REFERENCE_TEST_H
#define CNX_TESTS_ENUM_ENUM_UNQUALIFIED_REFERENCE_TEST_H
...
#endif /* CNX_TESTS_ENUM_ENUM_UNQUALIFIED_REFERENCE_TEST_H */
