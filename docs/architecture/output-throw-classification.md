...
| message                                                            | sites                                                                                                                                                                                                                                                                     |
| ------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `Error: 'this' can only be used inside a scope`                    | **9** — `PostfixExpressionGenerator.ts:470`, `:1344`, `CodeGenerator.ts:4558`, `BaseIdentifierBuilder.ts:43`, `AssignmentHandlerUtils.ts:21`, `AccessPatternHandlers.ts:45`, `StringHandlers.ts:99`, `BitmapHandlers.ts:199`, plus `CodeGenErrors.scopedTypeOutsideScope` |
...
| `BaseIdentifierBuilder.ts:43`    | `this` outside a scope — **1 of 9 copies**                                            | NEW E0426 | caller `CodeGenerator.ts:1247` holds the target ctx                          | none                                        |
...
- **#1277** — `CodeGenerator.ts:3523` fires on valid C-Next (`return { x: 1, y: 2 };` from a
