...
import { IInitializationError, IDeclarationInfo } from './types/IInitializationError.js';
...
export class InitializationAnalyzer {
    ...
    public declareVariable(
        ...
        const fields = isStruct ? this.structFields.get(typeName)! : new Set<string>();
     ...
     */
    public checkRead(name: string, line: number, column: number, field?: string): void {
        const state = this.lookupVariable(name);
...
class InitializationListener extends CNextListener {
    ...
    override enterVariableDeclaration = (ctx: Parser.VariableDeclarationContext): void => {
    ...
    override enterAssignmentStatement = (ctx: Parser.AssignmentStatementContext): void => {
    ...
    override enterPrimaryExpression = (ctx: Parser.PrimaryExpressionContext): void => {
