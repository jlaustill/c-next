...
int main(void) {
    ...
    if (max_minus_one != 254) return 21U;
    uint8_t combined = (10U + 20U) * 2U;
    if (combined != 60) return 22U;
    return 0U;
}
