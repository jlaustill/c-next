...
`TypeError` (`StringHandlers.ts:197`), so **181** sites are classified below — this audit covers
...
| `assignment/handlers/StringHandlers.ts:197`              | a `string<N>` capacity is always numeric — the grammar restricts that token to `[0-9]+`. The only site throwing a `TypeError` rather than an `Error`; its own comment records that coercing instead would yield a NaN capacity and corrupt every `strncpy` bound generated from it |
...
| file:line                                          | evidence                                                                                                                                                                                                                                                                                                                           |
| -------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `codegen/TypeValidator.ts:383`                     | in `validateBareIdentifierInScope`, which has **zero production callers** — repo-wide grep returns its definition, its unit test, a stale comment at `CodeGenerator.ts:3035`, and a plan doc. Superseded by `resolveBareIdentifier` (ADR-057), which resolves rather than throws                                                   |
| `codegen/TypeValidator.ts:389`                     | same function                                                                                                                                                                                                                                                                                                                      |
| `codegen/TypeValidator.ts:398`                     | same function                                                                                                                                                                                                                                                                                                                      |
| `codegen/TypeValidator.ts:404`                     | same function                                                                                                                                                                                                                                                                                                                      |
| `codegen/TypeValidator.ts:410`                     | same function                                                                                                                                                                                                                                                                                                                      |
| `codegen/TypeValidator.ts:417`                     | same function                                                                                                                                                                                                                                                                                                                      |
...
| `TypeValidator.ts:238`  | array index is negative                                           | NEW — **E0854 reserved** | `indexExprs[i].start`                                                                          | none                                               |
| `TypeValidator.ts:246`  | array index `N >= D`                                              | NEW — E0854              | `indexExprs[i].start`                                                                          | `array-initializers/bounds-error` +3               |
| `TypeValidator.ts:277`  | function signature does not match callback type                   | NEW                      | `valueExpr.start`                                                                              | none                                               |
| `TypeValidator.ts:286`  | cannot assign function to callback field (ADR-029 nominal typing) | NEW                      | `valueExpr.start`                                                                              | `callbacks/callback-error-nominal`                 |
| `TypeValidator.ts:539`  | `return` inside `critical` (ADR-050)                              | E0853                    | `stmt.returnStatement()!.start`                                                                | `critical/return-error`                            |
| `TypeValidator.ts:560`  | same, if-branch copy                                              | E0853                    | `innerStmt.returnStatement()!.start`                                                           | none                                               |
| `TypeValidator.ts:588`  | same, loop-body copy                                              | E0853                    | `loopStmt.returnStatement()!.start`                                                            | none                                               |
| `TypeValidator.ts:611`  | cannot switch on boolean (MISRA 16.7, ADR-025)                    | NEW E07xx                | `switchExpr.start`                                                                             | `switch/switch-error-boolean`                      |
| `TypeValidator.ts:617`  | switch needs >= 2 clauses (MISRA 16.6)                            | NEW E07xx                | `ctx.start`                                                                                    | `switch/switch-error-single-case`                  |
| `TypeValidator.ts:627`  | duplicate case value                                              | NEW E07xx                | `labelCtx.start`                                                                               | `switch/switch-error-duplicate-case` +2            |
| `TypeValidator.ts:667`  | switch covers N of M variants (explicit + default)                | NEW E07xx                | `ctx.start` / `defaultCase.start`                                                              | `switch/switch-error-wrong-count`                  |
| `TypeValidator.ts:676`  | non-exhaustive switch                                             | NEW E07xx                | `ctx.start`                                                                                    | `switch/switch-error-non-exhaustive`               |
| `TypeValidator.ts:737`  | nested ternary not allowed                                        | NEW E07xx                | `ctx.start` (`OrExpressionContext`)                                                            | none                                               |
| `TypeValidator.ts:755`  | condition must be boolean, not a ternary                          | E0701                    | `ctx.start`                                                                                    | none — untested arm                                |
| `TypeValidator.ts:827`  | condition must be boolean (MISRA 14.4)                            | E0701                    | `node.start` (already the precise operand)                                                     | `ternary/ternary-error-non-boolean` +7             |
| `TypeValidator.ts:851`  | loop condition is always true (ADR-068)                           | E0707                    | `ctx.start`                                                                                    | `control-flow/forever-disguised-*` (6)             |
| `TypeValidator.ts:980`  | function call in condition (MISRA 13.5)                           | E0702                    | `ctx.start`                                                                                    | `conditions/function-call-in-*-error`              |
| `TypeValidator.ts:993`  | function call in ternary condition                                | E0702                    | `ctx.start` (`OrExpressionContext`)                                                            | `conditions/function-call-in-ternary-error`        |
| `TypeValidator.ts:1018` | negative shift amount is undefined behavior                       | NEW E08xx                | `ctx.start` / `rightExpr.start`                                                                | `bitwise/shift-negative-error`                     |
| `TypeValidator.ts:1027` | shift exceeds type width (MISRA 12.2)                             | NEW E08xx                | `ctx.start`                                                                                    | `bitwise/shift-beyond-width-*` (4)                 |
...
| `…/PostfixExpressionGenerator.ts:624`           | `.length` deprecated (ADR-058)                                                                | NEW E06xx | `PostfixOpContext` not threaded                                                                              | `errors/length-property-deprecated`                     |
| `…/PostfixExpressionGenerator.ts:739`           | `.bit_length` unsupported on `args`                                                           | NEW E06xx | `IExplicitLengthContext` carries no node                                                                     | none                                                    |
| `…/PostfixExpressionGenerator.ts:761`           | `.bit_length` — type not in registry (**undeclared identifier**)                              | NEW E04xx | not threaded                                                                                                 | none                                                    |
| `…/PostfixExpressionGenerator.ts:843`           | `.bit_length` on an unsupported member type                                                   | NEW E06xx | not threaded                                                                                                 | none                                                    |
| `…/PostfixExpressionGenerator.ts:873`           | `.bit_length` on an unsupported type                                                          | NEW E06xx | not threaded                                                                                                 | none                                                    |
| `…/PostfixExpressionGenerator.ts:914`           | `.bit_length` on an array of unknown dimensions                                               | NEW E06xx | not threaded                                                                                                 | none                                                    |
| `…/PostfixExpressionGenerator.ts:921`           | `.bit_length` on an array of unsupported element type                                         | NEW E06xx | not threaded                                                                                                 | none                                                    |
| `…/PostfixExpressionGenerator.ts:957`           | `.bit_length` on a string of unknown capacity                                                 | NEW E06xx | not threaded                                                                                                 | none                                                    |
| `…/PostfixExpressionGenerator.ts:983`           | `.byte_length` unsupported on `args`                                                          | NEW E06xx | not threaded                                                                                                 | none                                                    |
| `…/PostfixExpressionGenerator.ts:1015`          | `.byte_length` — type not in registry (**undeclared identifier**)                             | NEW E04xx | not threaded                                                                                                 | none                                                    |
| `…/PostfixExpressionGenerator.ts:1067`          | `.element_count` on a non-array struct field                                                  | NEW E06xx | not threaded                                                                                                 | none                                                    |
| `…/PostfixExpressionGenerator.ts:1084`          | `.element_count` — type not in registry (**undeclared identifier**)                           | NEW E04xx | not threaded                                                                                                 | none                                                    |
| `…/PostfixExpressionGenerator.ts:1090`          | `.element_count` on a non-array variable                                                      | NEW E06xx | not threaded                                                                                                 | none                                                    |
| `…/PostfixExpressionGenerator.ts:1097`          | `.element_count` on an array of unknown dimensions                                            | NEW E06xx | not threaded                                                                                                 | none                                                    |
| `…/PostfixExpressionGenerator.ts:1106`          | `.element_count` on a fully subscripted array                                                 | NEW E06xx | not threaded                                                                                                 | none                                                    |
| `…/PostfixExpressionGenerator.ts:1153`          | `.char_count` on `args`                                                                       | NEW E06xx | not threaded                                                                                                 | none                                                    |
| `…/PostfixExpressionGenerator.ts:1169`          | `.char_count` on a non-string struct field                                                    | NEW E06xx | not threaded                                                                                                 | none                                                    |
| `…/PostfixExpressionGenerator.ts:1180`          | `.char_count` — type not in registry (**undeclared identifier**)                              | NEW E04xx | not threaded                                                                                                 | none                                                    |
| `…/PostfixExpressionGenerator.ts:1187`          | `.char_count` on a non-string variable                                                        | NEW E06xx | not threaded                                                                                                 | none                                                    |
| `…/PostfixExpressionGenerator.ts:1345`          | `this` outside a scope — every member except `length`                                         | NEW E04xx | `IMemberAccessContext` carries no node                                                                       | none                                                    |
| `…/PostfixExpressionGenerator.ts:1785`          | bracket indexing on a bitmap (ADR-034)                                                        | NEW       | **`ctx.op.start` available and already read**, spent on `Error at line 45:` prose — cheapest site to convert | `bitmap/bitmap-bracket-indexing-error`                  |
| `…/PostfixExpressionGenerator.ts:2002`          | float bit-range read at global scope                                                          | NEW E08xx | `IFloatBitRangeContext` carries no node; the subscript `op` is available upstream                            | none                                                    |
