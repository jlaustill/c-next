...
| **C** | no AST node anywhere; must be threaded from callers                                                 | `ScopeResolver.ts:37/53` (string-only signature, 4+ callers), `SizeofResolver.ts:154`, `TypeResolver.ts:153/159/771/779`, most of `PostfixExpressionGenerator` (`IPostfixContext`, `IExplicitLengthContext`, `IMemberAccessContext` and `IFloatBitRangeContext` carry only strings) |
...
| `TypeResolver.ts:771`   | narrowing assignment                                              | NEW E08xx                | same                                                                                           | `casting/narrowing-assign-error`                   |
| `TypeResolver.ts:779`   | sign-change assignment                                            | NEW E08xx                | same                                                                                           | `casting/sign-assign-error`                        |
