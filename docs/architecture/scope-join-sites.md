...
| `src/TRANSPILE/3-Render/codegen/assignment/AssignmentClassifier.ts`            | `firstId`          | 1      | path    | --         |
| `src/TRANSPILE/3-Render/codegen/assignment/AssignmentClassifier.ts`            | `scopeName`        | 2      | path    | --         |
