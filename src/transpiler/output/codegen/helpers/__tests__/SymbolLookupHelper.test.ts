...
describe("SymbolLookupHelper", () => {
  describe("hasSymbolWithKindAndLanguage", () => {
    ...
    it("returns false when kind doesn't match", () => {
      const mockTable = {
        getOverloads: () => [
          { kind: "variable", sourceLanguage: ESourceLanguage.C },
        ],
      };
      expect(
        SymbolLookupHelper.hasSymbolWithKindAndLanguage(
    ...
    it("returns false when language doesn't match", () => {
      const mockTable = {
        getOverloads: () => [
          { kind: "function", sourceLanguage: ESourceLanguage.CNext },
        ],
      };
      expect(
        SymbolLookupHelper.hasSymbolWithKindAndLanguage(
    ...
    it("returns true when matching symbol found", () => {
      const mockTable = {
        getOverloads: () => [
          { kind: "function", sourceLanguage: ESourceLanguage.C },
        ],
      };
      expect(
        SymbolLookupHelper.hasSymbolWithKindAndLanguage(
    ...
    it("returns true when any language in list matches", () => {
      const mockTable = {
        getOverloads: () => [
          { kind: "function", sourceLanguage: ESourceLanguage.Cpp },
        ],
      };
      expect(
        SymbolLookupHelper.hasSymbolWithKindAndLanguage(
  ...
  describe("isCppEnumClass", () => {
    ...
    it("returns true for C++ enum", () => {
      const mockTable = {
        getOverloads: () => [
          { kind: "enum", sourceLanguage: ESourceLanguage.Cpp },
        ],
      };
    ...
    it("returns false for C enum", () => {
      const mockTable = {
        getOverloads: () => [
          { kind: "enum", sourceLanguage: ESourceLanguage.C },
        ],
      };
  ...
  describe("isCppType", () => {
    ...
    it("returns true for C++ struct", () => {
      const mockTable = {
        getOverloads: () => [
          { kind: "struct", sourceLanguage: ESourceLanguage.Cpp },
        ],
      };
    ...
    it("returns true for C++ class", () => {
      const mockTable = {
        getOverloads: () => [
          { kind: "class", sourceLanguage: ESourceLanguage.Cpp },
        ],
      };
    ...
    it("returns true for C++ type alias", () => {
      const mockTable = {
        getOverloads: () => [
          { kind: "type", sourceLanguage: ESourceLanguage.Cpp },
        ],
      };
    ...
    it("returns false for C struct", () => {
      const mockTable = {
        getOverloads: () => [
          { kind: "struct", sourceLanguage: ESourceLanguage.C },
        ],
      };
  ...
  describe("isCNextFunction", () => {
    ...
    it("returns false for C-Next struct", () => {
      const mockTable = {
        getOverloads: () => [
          { kind: "struct", sourceLanguage: ESourceLanguage.CNext },
        ],
      };
