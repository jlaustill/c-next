...
int main(void) {
    ...
    device.flags = (device.flags & ~(1 << 1)) | ((true ? 1 : 0) << 1);
    device.flags = (device.flags & ~(1 << 2)) | ((false ? 1 : 0) << 2);
    ...
    device.status = (device.status & ~(1 << 0)) | ((true ? 1 : 0) << 0);
    device.status = (device.status & ~(1 << 1)) | ((false ? 1 : 0) << 1);
    device.status = (device.status & ~(1 << 2)) | ((false ? 1 : 0) << 2);
    ...
    ctrl.counter = 999;
    ctrl.controlFlags = (ctrl.controlFlags & ~(1 << 0)) | ((true ? 1 : 0) << 0);
    ...
    device.status = (device.status & ~(1 << 2)) | ((true ? 1 : 0) << 2);
