...
| `support/IncludeGenerator.ts:54`                | included C-Next file not found                                                                | NEW E0506 | `includeDir` at `CodeGenerator.ts:2466`; `.start.line` read at `:2470` but not threaded                      | none                                                    |
