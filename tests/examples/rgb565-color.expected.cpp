...
int main(void) {
    ...
    if (((modified >> 0U) & ((1U << 5U) - 1)) != 15) return 15;
    uint16_t custom = 0U;
    ...
    if (((custom >> 0U) & ((1U << 5U) - 1)) != 16) return 18;
