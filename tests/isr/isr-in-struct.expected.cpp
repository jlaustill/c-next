...
int main(void) {
    ...
    holder.primary = structHandler1;
    holder.primary();
    if (structCallCount != 1) return 1U;
    if (structLastHandler != 1) return 2U;
    structCallCount = 0U;
    structLastHandler = 0U;
    holder.secondary = structHandler2;
    holder.secondary();
    if (structCallCount != 1) return 3U;
    if (structLastHandler != 2) return 4U;
    structCallCount = 0U;
    structLastHandler = 0U;
    initStructHolder(holder, structHandler1, structHandler3);
    invokeStructHolder(holder);
    if (structCallCount != 2) return 5U;
    if (structLastHandler != 3) return 6U;
    structCallCount = 0U;
    holder.primary = structHandler2;
    holder.secondary = structHandler1;
    invokeStructHolder(holder);
    if (structCallCount != 2) return 7U;
    if (structLastHandler != 1) return 8U;
    structCallCount = 0U;
    structLastHandler = 0U;
    holder.primary = structHandler3;
    holder.primary();
    if (structCallCount != 1) return 9U;
    if (structLastHandler != 3) return 10U;
    return 0U;
}
