#ifndef F64_ARRAY_LENGTH_TEST_H
#define F64_ARRAY_LENGTH_TEST_H
...
/* External variables */
extern double globalArr[16];
extern double TestScope_publicArr[16];
