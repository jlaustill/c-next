#ifndef U64_ARRAY_LENGTH_TEST_H
#define U64_ARRAY_LENGTH_TEST_H
...
/* External variables */
extern uint64_t globalArr[16];
extern uint64_t TestScope_publicArr[16];
