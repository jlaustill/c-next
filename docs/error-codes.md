...
| E08xx     | Arithmetic/Array Safety | 13     |
| E09xx     | NULL Safety             | 8      |
| **Total** |                         | **42** |
...
| E0806 | Compound assignment used on a `bool` (MISRA C:2012 Rule 10.1)                        | Only `<-` is valid on a bool; flip a flag with `flag <- !flag`                           | `output/codegen/TypeValidator.ts`             |
