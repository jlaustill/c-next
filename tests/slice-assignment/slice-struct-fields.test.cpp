...
int main(void) {
    ...
    const uint32_t cnx_tmp0 = (uint32_t)(config.magic);
    ...
    const uint16_t cnx_tmp1 = (uint16_t)(config.version);
    ...
    const uint64_t cnx_tmp2 = (uint64_t)(config.timestamp);
    buffer[7] = (uint8_t)(cnx_tmp2);
    buffer[8] = (uint8_t)(cnx_tmp2 >> 8U);
    buffer[9] = (uint8_t)(cnx_tmp2 >> 16U);
    buffer[10] = (uint8_t)(cnx_tmp2 >> 24U);
    buffer[11] = (uint8_t)(cnx_tmp2 >> 32U);
