...
int main(void) {
    MOTOR_STATUS = (MOTOR_STATUS & ~(1 << 0)) | (1 << 0);
    MOTOR_STATUS = (MOTOR_STATUS & ~(1 << 1)) | (0 << 1);
    ...
    MOTOR_CONTROL = (MOTOR_CONTROL & ~(1 << 1)) | (0 << 1);
    MOTOR_CONTROL = (MOTOR_CONTROL & ~(0xFF << 2)) | ((127 & 0xFF) << 2);
    uint8_t speed = ((MOTOR_CONTROL >> 2) & 0xFF);
    bool enabled = ((MOTOR_CONTROL >> 0) & 1);
    MOTOR_DATA = (MOTOR_DATA & ~(1 << 0)) | (1 << 0);
    MOTOR_DATA = (MOTOR_DATA & ~(1 << 15)) | (0 << 15);
    MOTOR_DATA = (MOTOR_DATA & ~(1 << 31)) | (1 << 31);
