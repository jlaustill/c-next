#ifndef CNX_TESTS_FUNCTIONS_NAMED_TYPEDEF_STRUCT_ARRAY_TEST_H
#define CNX_TESTS_FUNCTIONS_NAMED_TYPEDEF_STRUCT_ARRAY_TEST_H
...
#endif /* CNX_TESTS_FUNCTIONS_NAMED_TYPEDEF_STRUCT_ARRAY_TEST_H */
