#ifndef CNX_TESTS_SCOPE_SCOPE_ATOMIC_MODIFIER_TEST_H
#define CNX_TESTS_SCOPE_SCOPE_ATOMIC_MODIFIER_TEST_H
...
#endif /* CNX_TESTS_SCOPE_SCOPE_ATOMIC_MODIFIER_TEST_H */
